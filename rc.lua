...
cpuwidget = wibox.widget {
    ...
    set_width = 30,
    opacity = "1",
    set_color = gears.color.create_solid_pattern("#00ff00"),
}
...
memwidget  = wibox.widget.graph()
        ...
        memwidget:set_color(gears.color.create_solid_pattern("#0051ff"))
        vicious.cache(vicious.widgets.mem)
        memwidget.opacity = "1"
        vicious.register(memwidget, vicious.widgets.mem, "$1", 11)
    beautiful.graph_bg = "#5b6678"
